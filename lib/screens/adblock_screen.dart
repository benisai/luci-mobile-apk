      ...
      child: Column(
        ...
        children: [
          ...
          SwitchListTile(
            ...
            onChanged: isSaving
                ? null
                : (value) => onChanged(settings.copyWith(safeSearch: value)),
          ),
          SwitchListTile(
            contentPadding: EdgeInsets.zero,
            title: const Text('Enable reporting'),
            value: settings.reportEnabled,
            onChanged: isSaving
                ? null
                : (value) => onChanged(settings.copyWith(reportEnabled: value)),
          ),
          ...
          const SizedBox(height: 12),
          TextFormField(
            initialValue: settings.dnsBackend,
            enabled: !isSaving,
            decoration: const InputDecoration(labelText: 'DNS backend'),
            onChanged: (value) =>
                onChanged(settings.copyWith(dnsBackend: value)),
          ),
          const SizedBox(height: 16),
          FilledButton.icon(
